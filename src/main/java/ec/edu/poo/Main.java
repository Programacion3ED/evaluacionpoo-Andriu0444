...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("\n=== CANTIDAD ===");
        System.out.println("Activos registrados: " + gestor.obtenerCantidadActivos()); // 5


        System.out.println("\n=== BUSQUEDA ===");
        ActivoDigital encontrado = gestor.buscarPorCodigo("FW001");
        System.out.println("Buscar FW001: " + (encontrado != null ? encontrado.getNombre() : "No encontrado"));
        System.out.println("Buscar XXXX:  " + (gestor.buscarPorCodigo("XXXX") != null ? "Encontrado" : "No encontrado"));
